...
const IntellectualSection = () => {
  // Для Intellectual секції літери залишаємо стандартні, а тексти беремо з JSON
  const logoLetters = ["G", "Λ", "I", "I", "Λ"]; 
  const subtitle = contentData.intellectual.subtitle;
  const description = contentData.intellectual.description;
